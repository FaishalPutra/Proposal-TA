...
Analisis risiko dilakukan untuk mengidentifikasi potensi hambatan yang dapat memengaruhi kelancaran proses pengembangan dan keberhasilan implementasi aplikasi kolaborasi mahasiswa. Mengingat keterbatasan waktu, sumber daya, serta dependensi antar tahapan pengembangan, tidak semua risiko memiliki tingkat urgensi yang sama. Oleh karena itu, tuags akhir ini memfokuskan analisis pada risiko-risiko yang memiliki dampak terbesar terhadap keberhasilan sistem rekomendasi dan proses pengujian desain disajikan pada tabel
...
\textbf{4} &
Integrasi modul rekomendasi dengan UI \textit{people to project} gagal atau tidak stabil &

...
\addbibresource{Proposal TA.bib}
...
\begin{center}
    ...
    {\Large\bfseries PENGEMBANGAN APLIKASI KOLABORASI MAHASISWA: MODUL REKOMENDASI \textit{PEOPLE TO PROJECT} MENGGUNAKAN \textit{AFFINITY BASED MATCHING}}\\
     \vspace{4cm}
